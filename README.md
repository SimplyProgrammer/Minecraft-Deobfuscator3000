...
It also has more user-friendly UI with tooltips, logging console and other things! Deobfuscator3000 perfect choice for minecraft modders that lost their source code or for anyone that is interested in sources of other mods!
